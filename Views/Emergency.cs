...
namespace BeldenCableInspection.Views
{
    public partial class Emergency : UserControl
    {
        ...
        public Emergency(EmergencySource source)
        {
            InitializeComponent();
            if (source == EmergencySource.EmergencyStop)
            {
                message.Text = "Emergency Stop Active!";
                instructions.Text = "1. Release the emergency button.";
            }
        }
